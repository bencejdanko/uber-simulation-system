...
const connectDB = async () => {
  try {
    ...
    console.log('Continuing without MongoDB for testing/demo purposes...');
    return false;
  }
};
...
const connectKafka = async () => {
  try {
    ...
    console.log('Continuing without Kafka for testing/demo purposes...');
    return false;
  }
};
...
app.get('/', (req, res) => {
  res.status(200).json({
    service: 'Uber Billing Service',
    version: '1.0.0',
    description: 'API for managing billing and pricing in the Uber simulation system',
    endpoints: {
      health: '/health',
      bills: '/api/v1/bills',
